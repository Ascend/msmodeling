...
在系统环境，或 `[deploy]` 所指向的路径下，确认服务化与测评工具能正常运行。可参考 [VLLM Server](https://docs.vllm.ai/projects/ascend/en/latest/quick_start.html)、[MindIE Service](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/docs/zh/user_guide/quick_start_motor.md)，以及 [AISBench 测评工具部署](https://gitee.com/aisbench/benchmark/blob/master/README.md)。
